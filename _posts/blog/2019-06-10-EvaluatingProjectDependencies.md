...
I’ll start with a recent example from a project I’m working on. [RainbowRedux]({{ site.url }}{% post_url blog/2019-01-13-RainbowSixRevivalProject %}) is requiring more and more linear algebra functions like matrix and vector operations. So far I’ve scraped through with a design that has allowed me to leverage the math libraries of the supported engines, and keeping the core library independent of this code.
